...
elements.push (
    <li className="page-item">
        <Link to={`/posts/?page=${i}`} className="page-link">{i}</Link>
    </li>
)
    }
    return elements;
...
const prev =() => {
  ...
  <ul className="pagination">
    <li className="page-item"><Link to={prev()} className="page-link">Previous</Link></li>
    {renderButtons()}
    <li className="page-item"><Link to={next()} className="page-link">Next</Link></li>
  </ul>
</nav>
    )
}